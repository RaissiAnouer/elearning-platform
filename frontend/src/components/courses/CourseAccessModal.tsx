...
const CourseAccessModal: React.FC<CourseAccessModalProps> = ({
  isOpen,
  onClose,
  courseTitle,
}) => {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                  <p className="text-sm text-gray-500">
                    To access <span className="font-medium">{courseTitle}</span>, please log in to your account or create a new one.
                  </p>
                </div>
